...
from data_services.utils.data_process_utils import TimeSeriesDataQuery, preprocess_df, remove_duplicates
...
def build_ohlcv_query(universe: Universe | typing.Tuple, start: type[datetime], 
                      end: type[datetime], exchange: str= "US"):
    """
...
async def get_data(vendor: type[MarketDataVendor], universe: Universe | typing.Tuple,
                    start: type[datetime], end: type[datetime], exchange: str= "US",
                    do_archive: bool = False) -> typing.Coroutine[any, any, any]:
    """
    ...
    if not hasattr(provider, "fetch_multi_symbols_data"):
        raise NotImplementedError(f"'fetchMultiSymbols' method has not been implemented for this vendor...")        
...
def get_last_data(vendor: type[MarketDataVendor], universe: Universe | typing.Tuple, 
                  exchange: str="US", do_archive: bool = False):
    """
...
if __name__ == "__main__":
    ...
    _, data = asyncio.run(get_data(EodhdVendor, universe, start, end, do_archive=True))
